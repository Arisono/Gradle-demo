...
public class RetrofitApp {
	...
	public static Retrofit retrofit = new Retrofit.Builder().baseUrl("http://192.168.253.200:8080/Chapter/")
			.addConverterFactory(StringConverterFactory.create()).addConverterFactory(GsonConverterFactory.create())
			.build();
...
//				.getApiGetException(new NetResquestSubscriber<>(new SubscriberOnNextListener<HttpResult<Object>>() {
//
//					@Override
